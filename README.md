...
პროექტის ფუნქციები:
 ...
 Database: Postgres
  ...
  სადემონსტრაციოდ არის ჰეროკუს სერვერზე დაჰოსტილი:
  >>>  https://swisscapital.herokuapp.com   <<< 


  ეს პროექტი არის დაჰოსტილი ჰროკუზე უბრალოდ სვა რეპოზიტორია არის გამოყენებული, რომელიც ანალოგიურია ამ რეპოზიტორიის:
